		...
		<TBODY align=center>
			...
			<TR>
				<c:forEach var="item" items="${myOrderList }">
					...
					<td>
					  <h2>${item.order_goods_qty * item.goods_sales_price * 0.9 + item.goods_delivery_price}원</h2>
					</td>
			</TR>
			</c:forEach>
		</TBODY>
...
<form  name="form_order">
	...
	<center>
		...
		<div class="box_buttons">
       	 	<input type="submit" id="insertButton" class="button_submit" value="쇼핑 계속하기" onclick="location.href='/homeForm.do'">
    	</div>
<DIV class="clear"></DIV>		
