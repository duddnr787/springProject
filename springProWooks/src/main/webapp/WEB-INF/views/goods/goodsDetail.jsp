...
<body>
	...
	<div id="detail_table">
		<table>
			<tbody>
				...
				<tr>
					...
					<td class="fixed">
			      <select style="width: 60px;" id="goods_count">
		...
		<ul>
			<li><a class="buy" href="javascript:fn_order_each_goods('${goods.goods_id }','${goods.goods_title }','${goods.goods_price}','${goods.goods_fileName}','${goods.goods_delivery_price}');">구매하기 </a></li>
	...
	<div id="layer" style="visibility: hidden">
		...
		<div id="popup"></div>
			...
			<a href="javascript:" onClick="imagePopup('close', '.layer01')"> <img
